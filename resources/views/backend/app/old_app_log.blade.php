...
@section('title', 'Bikroyik :: Old App Log')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> Old App LOG</strong>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <label for="type" class="col-form-label">Search Table
                                        <span class="text-danger"><strong>*</strong></span>
                                    </label>
                                    <select class="selectpicker form-control" id="table" title="Select table" data-live-search="true">
...
@section('script')
   <script>
        ...
        $('#gen').click(function (e) {
            ...
            if(!table){
                $.notify('Choose Table', {className: 'error', position: 'top right'});
                cheeck = 0;
            }
            else if(!type){
            ...
            if(cheeck == 1)
            {
                ...
                var t = $('#appLog_table').DataTable({
                    ...
                    ajax: {
                        "url": "/old-app-log-data",
                        "dataSrc": "data",
                        data: { table:table, type:type, data:data, startdate: startdate, enddate: enddate },
