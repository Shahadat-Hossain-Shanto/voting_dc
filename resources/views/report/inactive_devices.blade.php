...
@section('title', 'Bikroyik :: Inactive Devices')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> Inactive Devices</strong></h5>
                        </div>
                        <div class="card-body">
                            <div class="row container-fluid">
                                <div class="col-lg-3 col-md-6 col-sm-6" id="totalSold" hidden>
                                    <div class="card card-stats card-height">
                                        <div class="card-header card-header-warning card-header-icon">
                                            <div class="card-icon">
                                                <i class="fas fa-duotone fa-mobile nav-icon"></i>
                                            </div>
                                            <p class="card-category">Total Inactive Devices</p>
                                            <h3 class="card-title"id="total_sales">
                            ...
                            <div class="row" id="dataTable" hidden>
                                <div class="pt-3">
                                    <div class="table-responsive">
                                        <table id="inactive_emi_table" class="display table-bordered" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Index</th>
                                                    <th>Customer ID</th>
                                                    ...
                                                    <th>IMEI 2</th>
                                                    <th>Purchase Date</th>
                                                    <th>Server Sync Date and Time</th>
                                                    <th>Retail Id</th>
                                                    <th>Retail Name</th>
                                                    <th>Brand</th>
                                                    <th>Model</th>
        ...
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
              <div class="modal-body"  id="printData">
                <div class="m-20">
                    <h1><b><center>Retailer Sale</center></b></h1>
...
@section('script')
    <script type="text/javascript" src="{{ asset('js/backend/inactive_devices.js') }}"></script>
@endsection
