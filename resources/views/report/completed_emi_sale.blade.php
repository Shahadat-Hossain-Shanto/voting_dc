...
@section('title', 'Bikroyik :: EMI Completed Devices')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> EMI Completed Device List</strong>
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row container-fluid">
                                <div class="col-lg-3 col-md-6 col-sm-6" id="totalCompleted" hidden>
                                    <div class="card card-stats card-height">
                                        <div class="card-header card-header-warning card-header-icon">
                                            <div class="card-icon">
                                                <i class="fas fa-duotone fa-mobile nav-icon"></i>
                                            </div>
                                            <p class="card-category">Total Completed Sales</p>
                                            <h3 class="card-title"id="completed_emi"></h3>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row" id="dataTable" hidden>
                                <div class="pt-3">
                                    <div class="table-responsive">
                                        <table id="monthly_emi_table" class="display table-bordered" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>Index</th>
                                                    <th>Customer ID</th>
...
@section('script')
    <script type="text/javascript" src="{{ asset('js/backend/completed_emi_sale.js') }}"></script>
@endsection
