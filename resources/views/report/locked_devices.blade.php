...
@section('title', 'Bikroyik :: Locked Devices')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> Locked Devices</strong></h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6" id="totalSold" hidden>
                                    <div class="card card-stats card-height">
                                        <div class="card-header card-header-warning card-header-icon">
                                            ...
                                            <p class="card-category">Total Locked Devices</p>
...
@section('script')
    <script type="text/javascript" src="{{ asset('js/backend/locked_devices.js') }}"></script>
@endsection
