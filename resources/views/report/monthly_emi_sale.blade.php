...
@section('title', 'Bikroyik :: Pos Sales')
                ...
                <div class="col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="m-0"><strong><i class="fas fa-clipboard-list"></i> Pos Sales</strong></h5>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6" id="totalSold" hidden>
                                    <div class="card card-stats card-height">
                                        <div class="card-header card-header-warning card-header-icon">
                                            ...
                                            <p class="card-category">Total Device Sold</p>
                                            <h3 class="card-title" id="total_sales"> </h3>
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    <script type="text/javascript" src="{{ asset('js/backend/monthly_emi_sale.js') }}"></script>
@endsection
